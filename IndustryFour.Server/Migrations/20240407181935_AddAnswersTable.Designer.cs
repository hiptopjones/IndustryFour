...
namespace IndustryFour.Server.Migrations
{
    ...
    [Migration("20240407181935_AddAnswersTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IndustryFour.Server.Models.Question", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("QuestionText")
                        .HasDatabaseName("ix_questions_question");

                    b.HasIndex("TurnId")
                        .HasDatabaseName("ix_questions_turn_id");
            ...
            modelBuilder.Entity("IndustryFour.Server.Models.Question", b =>
                {
                    b.HasOne("IndustryFour.Server.Models.Turn", "Turn")
                        .WithMany()
                        .HasForeignKey("TurnId")
                        .IsRequired()
                        .HasConstraintName("fk_questions_turns_turn_id");
